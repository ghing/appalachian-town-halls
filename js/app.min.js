...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _interopRequireWildcard(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t.default=e,t}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.App=void 0;var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}();require("core-js/fn/object/assign"),require("es6-promise/auto"),require("isomorphic-fetch");var _d=require("d3"),d3=_interopRequireWildcard(_d),_MeetingStore=require("./MeetingStore"),_MeetingStore2=_interopRequireDefault(_MeetingStore),_VoteStore=require("./VoteStore"),_VoteStore2=_interopRequireDefault(_VoteStore),_timeline=require("./timeline"),_timeline2=_interopRequireDefault(_timeline),_repsearch=require("./repsearch"),_repsearch2=_interopRequireDefault(_repsearch),_repcontext=require("./repcontext"),_repcontext2=_interopRequireDefault(_repcontext),App=exports.App=function(){function e(t){var n=this;_classCallCheck(this,e),this.timelineContainer=t.timelineContainer,this.repSearchContainer=t.repSearchContainer,this.repContextContainer=t.repContextContainer,this.googleApiKey=t.googleApiKey,this.labels=Object.assign({},t.labels),this.meetingStore=new _MeetingStore2.default,this.voteStore=new _VoteStore2.default,this.startDate=t.startDate||new Date(2017,0,20),this.endDate=t.endDate||new Date,this.annotations=t.annotations||{"2017-01-20":{label:"Inauguration day"},"2017-02-20":{label:"District work period begins"},"2017-02-24":{label:"District work period ends"},"2017-04-10":{label:"District work period begins"},"2017-04-21":{label:"District work period ends"}},this.handleAddress=this.handleAddress.bind(this),this.handleReset=this.handleReset.bind(this),this.timeline=(0,_timeline2.default)(),this.search=(0,_repsearch2.default)().handleAddress(this.handleAddress).handleReset(this.handleReset),this.context=(0,_repcontext2.default)().labels(this.labels),this.allDays=[],this.searchAddress=null;var i=fetch(t.officialMeetingsJsonUrl).then(function(e){return e.json()}).then(function(e){return e.objects}),r=fetch(t.ahcaVotesJsonUrl).then(function(e){return e.json()}).then(function(e){return e.votes});Promise.all([i,r]).then(function(t){var i=t[0],r=t[1];n.meetingStore.setOfficials(i),n.voteStore.setVotes(r),n.allDays=e.meetingsByDay(n.meetingStore,n.startDate,n.endDate,n.annotations),n.renderTimeline(n.allDays),d3.select(n.repSearchContainer).call(n.search)})}return _createClass(e,[{key:"handleReset",value:function(){null!==this.searchAddress&&(this.renderTimeline(this.allDays),d3.select(this.repContextContainer).datum(null).call(this.context))}},{key:"renderTimeline",value:function(e){d3.select(this.timelineContainer).datum(e).call(this.timeline,this.ahcaVoteForDivision.bind(this))}},{key:"handleAddress",value:function(t,n){var i=this;this.searchAddress=t;var r="https://content.googleapis.com/civicinfo/v2/representatives?address="+encodeURIComponent(t)+"&includeOffices=false&levels=country&roles=legislatorLowerBody&alt=json&key="+this.googleApiKey;fetch(r).then(function(e){return e.json()}).then(function(t){if(!t)return void n({msg:i.labels.noDistrictFound},null);var r=Object.keys(t.divisions);1!==r.length&&n({msg:0===r.length?i.labels.noDistrictFound:i.labels.multipleDistrictsFound},null);var o=r[0];n(null,{});var s=i.meetingStore.getMeetingsForDivision(r[0]),a={};s.forEach(function(e){a[e.id]=!0}),d3.select(i.repContextContainer).datum({official:i.meetingStore.getOfficialForDivision(o),numMeetings:s.length,avgMeetings:i.meetingStore.getAvgMeetings(),districtName:t.divisions[o].name,numPhoneMeetings:i.meetingStore.getPhoneMeetingsForDivision(o).length,pctPhoneMeetings:i.meetingStore.getPercentPhoneMeetings(),ahcaVote:i.ahcaVoteForDivision(o)}).call(i.context);var l=e.meetingsByDay(i.meetingStore,i.startDate,i.endDate,i.annotations,function(e){return a[e.id]});i.renderTimeline(l)})}},{key:"ahcaVoteForDivision",value:function(e){return this.voteStore.getVoteForDivision(e).vote_position.toLowerCase()}}],[{key:"meetingsByDay",value:function(e,t,n,i,r){var o=[],s=d3.timeFormat("%Y-%m-%d");return d3.timeDay.range(t,n,1).forEach(function(t,n){var a=s(t),l=e.getMeetingsForDate(a,r);(0!==l.length||i[a])&&o.push({day:n+1,date:t,meetings:l,label:i[a]?i[a].label:null})}),o.reverse()}}]),e}();


},{"./MeetingStore":1,"./VoteStore":2,"./repcontext":4,"./repsearch":5,"./timeline":6,"core-js/fn/object/assign":"core-js/fn/object/assign","d3":"d3","es6-promise/auto":9,"isomorphic-fetch":"isomorphic-fetch"}],4:[function(require,module,exports){
"use strict";function _interopRequireWildcard(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t.default=e,t}function officialLastName(e){var t=e.name.split(" ");return t[t.length-1]}function repContext(){var e=Object.assign({},DEFAULT_LABELS),t=function(t){t.each(function(t){var n=d3.select(this);if(n.selectAll("*").remove(),t){var i=n.append("div").attr("class","representative-context");t.districtName&&i.append("span").text(e.districtName(t)),t.official&&i.append("span").text(e.officialName(t)),t.numMeetings===t.avgMeetings?i.append("span").text(e.avgMeetings(t)):t.numMeetings>t.avgMeetings?i.append("span").text(e.aboveAvgMeetings(t)):i.append("span").text(e.belowAvgMeetings(t)),0===t.numPhoneMeetings?i.append("span").text(e.noPhoneMeetings(t)):i.append("span").text(e.phoneMeetings(t)),i.append("span").text(e.ahcaVote(t))}})};return t.labels=function(n){return n?(e=Object.assign(e,n),t):e},t}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=repContext,require("core-js/fn/object/assign");var _d=require("d3"),d3=_interopRequireWildcard(_d),_utils=require("./utils"),DEFAULT_LABELS={noDistrictFound:"Could not find a district matching this address",multipleDistrictsFound:"Found more than one districts matching this address",districtName:function(e){return"This address is in "+e.districtName+"."},officialName:function(e){return"The representative for this district is "+e.official.name+"."},avgMeetings:function(e){return"This representative has held "+(0,_utils.apStyleNumber)(e.numMeetings)+" "+(0,_utils.pluralize)("meeting",e.numMeetings)+", the average for Appalachian representatives."},aboveAvgMeetings:function(e){return"This representative has held "+(0,_utils.apStyleNumber)(e.numMeetings)+" "+(0,_utils.pluralize)("meeting",e.numMeetings)+", more than the average for Appalachian representatives."},belowAvgMeetings:function(e){var t=0===e.numMeetings?"no":e.numMeetings;return"This representative has held "+(0,_utils.apStyleNumber)(t)+" "+(0,_utils.pluralize)("meeting",e.numMeetings)+", below the average of "+(0,_utils.apStyleNumber)(e.avgMeetings)+" for Appalachian representatives."},noPhoneMeetings:function(e){return"This representative hasn't held any phone meetings. "+(0,_utils.pctFormat)(e.pctPhoneMeetings)+" percent of all meetings were held over the phone."},phoneMeetings:function(e){return"This representative held "+(0,_utils.apStyleNumber)(e.numPhoneMeetings)+" "+(0,_utils.pluralize)("meeting",e.numPhoneMeetings)+" over the phone.  "+(0,_utils.pctFormat)(e.pctPhoneMeetings)+" percent of all meetings were held over the phone."},ahcaVote:function(e){return officialLastName(e.official)+' voted "'+e.ahcaVote+'" on the American Healthcare Act.'}};
...
//# sourceMappingURL=data:application/json;base64,
